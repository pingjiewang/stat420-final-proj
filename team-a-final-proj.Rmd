...
Calculating coefficient of determination, R2 for the two models:

```{r}
# 2.2. Total sum of squares
SST = sum((autos_train$price - mean(autos_train$price))^2)
#y_hat = predict(model1_selected, newdata = autos_train, type = 'response')
y_hat = predict(model1_selected)

# 2.4. Residual sum of squares
SSReg = sum((y_hat - mean(autos_train$price))^2)

R2 = SSReg / SST
R2
n = length(resid(model1_selected))
p = length(coef(model1_selected))
x = (n-1/n-p)
z = 1-R2
adj_R2 = 1-(x*z)
adj_R2
...
# 2.2. Total sum of squares
SST = sum((autos_train$price - mean(autos_train$price))^2)
y_hat = predict(model2_selected, newdata = autos_train, type = 'response')
